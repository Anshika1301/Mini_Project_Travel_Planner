...
<?php include('includes/header.php');?>
    ...
    <section class="about_state container">
        <div class="row">
            <div class="col-lg-12">
                <h4>About Maharashtra</h4>
                <p style="color: grey;">Often called the 'Gateway to the Heart of India', Maharashtra is the third largest state and second most populous state than in the country. Owing to its proximity to the Western Ghats, it is blessed with a picturesque backdrop of the mountains on one side and has the beautiful Konkan coastal belt on the other.Maharashtra, the land of everything unlimited invites you into its widespread plethora of attractions. It is adorned by the beautiful Sahyadri ranges of the Western Ghats with high mountains that disappear into the morning mist, while the sprawling belt of the Konkan Coast mesmerises the eyes by its white beaches. The ruins of the ancient forts and palaces in Pune and Ratnagiri among others proudly narrates the story of the then mighty rulers of Maharashtra. Centuries-old temples situated in places like Pandharpur, Ozar are still rooted in their traditions, offering sanctuary to pilgrims. As do the small hill stations of Mahabaleshwar, Lonavala, Matheran, nestled cosily in nature, provide respite to travellers from the hustle and bustle of the cities.</p>
                <hr>
                <details>
                    <summary>Best time to visit</summary>
                    <p class="bttv">There is no particular best time to explore the state since the eevry season has its own pros and cons. However, winters are most suitable since the weather remains calm and pleasant. Summers are too scorching but are perfect to visit hilly regions. In monsoons also, heavy downpours are observed but, rains add to the beauty of mountainous areas</p>
                </details>
                <hr>
                <details>
                    <summary>How to reach</summary>
                    <p class="bttv"><span class="sub_t">By air :</span> Mumbai, the capital city has two airports, one international (Sahara International Airport) and Santa Cruz domestic airport. All leading domestic and international airlines operate regular flights to and from Mumbai. Other major domestic airports in Maharashtra are located at Pune, Aurangabad, Nagpur, Kolhapur and, Sholapur.</p>
                    <p class="bttv"><span class="sub_t">By rail :</span> Mumbai is the major railway junction of Maharashtra, which is served by many important trains that link the city to other cities of India. There are also major Railway Stations in or close by the tourist destinations.</p>
                    <p class="bttv"><span class="sub_t">By road :</span> Maharashtra has an excellent road network. A number of national highways and state highways connect all major cities of Maharashtra to other parts of the country.</p>
                </details>
...
<h2 class="title container" style="margin: 3rem auto; font-family: 'Oleo Script', cursive; font-size:2.5rem; text-align: center;">Places to visit in Maharastra</h2>
