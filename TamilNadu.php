...
<?php include('includes/header.php');?>
    ...
    <section class="about_state container">
        <div class="row">
            <div class="col-lg-12">
                <h4>About Tamil Nadu</h4>
                <p style="color: grey;">Tamil Nadu- A land of cultural and religious heritage, offers every chance to its tourists and pilgrims to be enchanted with the vast plethora of history and beauty that it has. It is a blend of both- the modern and the ancient, which makes Tamil Nadu a beautiful destination to explore and experience our past cultural heritage with all the amenities of the present.Lying along the Bay of Bengal, Tamil Nadu has a glorious history that spans to a millennium and a present, that is paving a way for it in becoming one of the most promising states in the country. This state has seen the rise and fall of many dynasties such as the Cholas, the Cheras and the Pallavas.</p>
                <hr>
                <details>
...
<div class="container">
    <div class="heading">
        <h2>Places To Visit In Tamil Nadu</h2>
    </div>
    <div class="row">
        <!-------------------- 1 ------------------------->
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Auroville.jpg" alt="sample87" />
                <figcaption>
                    <h2>Auroville</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/coimbator2.jpg" alt="sample87" />
                <figcaption>
                    <h2>Coimbatore</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Hogenakkal falls.jpg" alt="sample87" />
                <figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Kanchipuram.jpg" alt="sample87" />
                <figcaption>
                    <h2>Kanchipuram</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Kanyakumari temple.jpg" alt="sample87" />
                <figcaption>
                    <h2>Kanyakumari</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Kodaikanal-hills.jpg" alt="sample87" />
                <figcaption>
                    <h2>Kodaikanal</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Madurai.jpg" alt="sample87" />
                <figcaption>
                    <h2>Madurai</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Mahabalipuram.jpg" alt="sample87" />
                <figcaption>
                    <h2>Mahabalipuram</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="img/Tamil Nadu/Ooty.jpg" alt="sample87" />
                <figcaption>
                    <h2>Ooty</h2>
                    <a href="#"></a>
                </figcaption>
