...
<h2 class="title container" style="margin: 3rem auto; font-family: 'Oleo Script', cursive; font-size:2.5rem; text-align: center;">Places to visit in Thailand</h2>

<div class="container-slideshow">
  <div class="mySlides">
    <div class="numbertext">1 / 6</div>
    <img src="img/Foreign/Thailand/bangkok.png" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
    <img src="img/Foreign/Thailand/pattaya.png" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
    <img src="img/Foreign/Thailand/karbi.png" style="width:100%">
  </div>
    
  <div class="mySlides">
    <div class="numbertext">4 / 6</div>
    <img src="img/Foreign/Thailand/bankok.png" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="img/Foreign/Thailand/bangkok.png" style="width:100%" onclick="currentSlide(1)" alt="Bangkok">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/Thailand/pattaya.png" style="width:100%" onclick="currentSlide(2)" alt="Pattaya">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/Thailand/karbi.png" style="width:100%" onclick="currentSlide(3)" alt="Karbi">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/Thailand/bangkok.png" style="width:100%" onclick="currentSlide(4)" alt="Bangkok">
      
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/Thailand/pattaya.png" style="width:100%" onclick="currentSlide(5)" alt="Pattaya">
    </div>   
    <div class="column">
      <img class="demo cursor" src="img/Foreign/Thailand/karbi.png" style="width:100%" onclick="currentSlide(6)" alt="Karbi">
    </div>
