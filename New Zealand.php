    ...
    <section class="about_state container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p style="color: grey;">Backdrop for the legendary “Lord of the Rings” movies, New Zealand is a place with heavenly middle Earth beauty. Cascading waterfalls, deep fjords, hot water spring, steaming geysers, untamed wilds, clear beaches and dazzling glaciers; it’s just the beginning of its beautiful story. There are so many wonderful places to visit in New Zealand that it’s hard for people to decide which one to keep on the bucket list and which one to miss. Here is an attempt to sort this out with our list of most beautiful and famous New Zealand tourist attractions.</p>
                <hr>
...
<h2 class="title container" style="margin: 3rem auto; font-family: 'Oleo Script', cursive; font-size:2.5rem; text-align: center;">Places to visit in New Zealand</h2>

<div class="container-slideshow">
  <div class="mySlides">
    <div class="numbertext">1 / 6</div>
    <img src="img/Foreign/New Zealand/auckland.png" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
    <img src="img/Foreign/New Zealand/BayOfIsland.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
    <img src="img/Foreign/New Zealand/coromandel Pennisula.png" style="width:100%">
  </div>
    
  <div class="mySlides">
    <div class="numbertext">4 / 6</div>
    <img src="img/Foreign/New Zealand/firodland national park.png" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">5 / 6</div>
    <img src="img/Foreign/New Zealand/napier.png" style="width:100%">
  </div>
    
  <div class="mySlides">
    <div class="numbertext">6 / 6</div>
    <img src="img/Foreign/New Zealand/queenstown.png" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="img/Foreign/New Zealand/auckland.png" style="width:100%" onclick="currentSlide(1)" alt="">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/New Zealand/BayOfIsland.jpg" style="width:100%" onclick="currentSlide(2)" alt="">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/New Zealand/coromandel Pennisula.png" style="width:100%" onclick="currentSlide(3)" alt="">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/New Zealand/firodland national park.png" style="width:100%" onclick="currentSlide(4)" alt="">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/Foreign/New Zealand/napier.png" style="width:100%" onclick="currentSlide(5)" alt="">
    </div>   
    <div class="column">
      <img class="demo cursor" src="img/Foreign/New Zealand/queenstown.png" style="width:100%" onclick="currentSlide(6)" alt="">
    </div>
