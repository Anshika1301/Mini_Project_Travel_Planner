...
<h2 class="title container" style="margin: 3rem auto; font-family: 'Oleo Script', cursive; font-size:2.5rem; text-align: center;">Places to visit in Uttar Pradesh</h2>

<div class="container-slideshow">
  <div class="mySlides">
    <div class="numbertext">1 / 6</div>
    <img src="img/city_img/premmandir.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 6</div>
    <img src="img/city_img/janambhumi.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 6</div>
    <img src="img/city_img/radharaman.jpg" style="width:100%">
  </div>
    
  <div class="mySlides">
    <div class="numbertext">4 / 6</div>
    <img src="img/city_img/govardhanhill.jpg" style="width:100%">
  </div>

  <div class="mySlides">
    <div class="numbertext">5 / 6</div>
    <img src="img/city_img/nandgao.jpg" style="width:100%">
  </div>
    
  <div class="mySlides">
    <div class="numbertext">6 / 6</div>
    <img src="img/city_img/dwarakadheesh.jpg" style="width:100%">
  </div>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="img/city_img/premmandir.jpg" style="width:100%" onclick="currentSlide(1)" alt="Prem Mandir">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/city_img/janambhumi.jpg" style="width:100%" onclick="currentSlide(2)" alt="Shri Krishna Janam Bhumi">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/city_img/radharaman.jpg" style="width:100%" onclick="currentSlide(3)" alt="RadhaRaman">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/city_img/govardhanhill.jpg" style="width:100%" onclick="currentSlide(4)" alt="Govardhan Hill">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/city_img/nandgao.jpg" style="width:100%" onclick="currentSlide(5)" alt="Nandgaon">
    </div>   
    <div class="column">
      <img class="demo cursor" src="img/city_img/dwarakadheesh.jpg" style="width:100%" onclick="currentSlide(6)" alt="Dwarakadheesh Temple">
    </div>
...
<!---------------- You Might Also like section ---------------->
    ...
    <div class="container box-like">
        <div class="card">
            <div class="img">
                <img src="img/uttar pradesh.jpg">
            </div>
            <div class="top-text">
                <p>UttarPradesh Tour</p>
            </div>
            <div class="bottom-text">
                ...
                <div class="btn">
                    <a href="package-details.php?pkgid=19">Read more</a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="bottom-text">
                ...
                <div class="btn">
                    <a href="package-details.php?pkgid=16">Read more</a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="bottom-text">
                ...
                <div class="btn">
                    <a href="package-details.php?pkgid=24">Read more</a>
                </div>
            </div>
        </div>
        <div class="btn-class">
