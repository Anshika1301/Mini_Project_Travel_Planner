...
<?php include('includes/header.php');?>
    ...
    <section class="about_state container">
        <div class="row">
            <div class="col-lg-12">
                <h4>About Punjab</h4>
                <p style="color: grey;">Located in the northwestern part of India, Punjab means the land of five rivers. Known for its cuisine, culture and history, Punjab is visited by tourists who want to enjoy its vibrant culture and food.The fertile land of farms and forts, Punjab has been aptly nicknamed the 'Smiling Soul of India' where you will always see smiles on the faces of the inhabitants who take pride in their religion and culture. Though the state does not have any significant adventure activity to offer, yet entertainment is guaranteed! </p>
                <hr>
                <details>
                    <summary>Best time to visit</summary>
                    <p class="bttv">Punjab, the land of five rivers, is best visited between the months of October and March. It is winter and spring season in the state during this time. The weather is pleasantly cold at the beginning of the winter season and drops down incredibly during the peak season. It further makes exploring the attractions a tremendously enjoyable experience during the day without having to bear the scorching heat or rainfall. The summers, that follow immediately, make the state extremely hot and humid</p>
                </details>
                <hr>
                <details>
                    <summary>How to reach</summary>
                    <p class="bttv"><span class="sub_t">By air :</span> Punjab has two airports located at Chandigarh and Amritsar. Al most all-important airlines operate regular flights to both of these airports connecting them to major cities of India.</p>
                    <p class="bttv"><span class="sub_t">By rail :</span> Punjab is well linked to other parts of India by extensive railway network. Chandigarh, Ludhiana, Amritsar, Jalandhar, and Pathankot are the major railway stations in the state, which are served many important trains.</p>
                    <p class="bttv"><span class="sub_t">By road :</span> An excellent network of roads and state highways connect all-important cities of Punjab. The National highways NH1 or the Grand Trunk Road link the state directly to most of the significant places in northern and eastern India.</p>
                </details>
...
<h2 class="title container" style="margin: 3rem auto; font-family: 'Oleo Script', cursive; font-size:2.5rem; text-align: center;">Places to visit in Punjab</h2>
        ...
        <div class="el__overflow">
          <div class="el__inner">
            ...
            <div class="el__preview-cont">
              <h2 class="el__heading">Place-1</h2>
            </div> 
            <div class="el__content">
              <div class="el__text">Akal Thakt</div>
      ...
      <div class="el">
        <div class="el__overflow">
          <div class="el__inner">
            <div class="el__bg"></div>
            <div class="el__preview-cont">
              <h2 class="el__heading">Place 2</h2>
            </div>
            <div class="el__content">
              <div class="el__text">Golden Temple</div>
              <div class="el__close-btn"></div>
            </div>
          </div>
        </div>
      ...
      <div class="el">
        <div class="el__overflow">
          <div class="el__inner">
            <div class="el__bg"></div>
            <div class="el__preview-cont">
              <h2 class="el__heading">Place 3</h2>
            </div>
            <div class="el__content">
              <div class="el__text">Harmandir Sahib</div>
              <div class="el__close-btn"></div>
            </div>
          </div>
        </div>
      ...
      <div class="el">
        <div class="el__overflow">
          <div class="el__inner">
            <div class="el__bg"></div>
            <div class="el__preview-cont">
              <h2 class="el__heading">Place 4</h2>
            </div>
            <div class="el__content">
              <div class="el__text">Jallianwala Bagh</div>
              <div class="el__close-btn"></div>
            </div>
          </div>
        </div>
      ...
      <div class="el">
        <div class="el__overflow">
          <div class="el__inner">
            <div class="el__bg"></div>
            <div class="el__preview-cont">
              <h2 class="el__heading">Place 5</h2>
            </div>
            <div class="el__content">
              <div class="el__text">Museum</div>
              <div class="el__close-btn"></div>
            </div>
          </div>
        </div>
    ...
    <div class="container box-like">
        ...
        <div class="card">
            ...
            <div class="bottom-text">
                ...
                <div class="btn">
                    <a href="package-details.php?pkgid=5">Read more</a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="bottom-text">
                ...
                <div class="btn">
                    <a href="package-details.php?pkgid=17">Read more</a>
                </div>
            </div>
        </div>
        <div class="btn-class">
