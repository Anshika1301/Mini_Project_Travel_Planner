    ...
    <section class="about_state container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p style="color: grey;">One of the best places to visit for wildlife aficionados and nature lovers, Jharkhand is a state replete with a vast bounty of towering mountains, dense forests and gushing waterfalls. Blessed with a plethora of natural scenic vistas, Jharkhand is the place for you be if you are on the lookout for a one-on-one rendezvous with unperturbed, untouched nature. There is more to Jharkhand than just its scenic landscapes though, with several museums, temples and wildlife reserves scattered around the state. Formerly a part of Bihar, Jharkhand was carved out as a separate state almost two decades ago, thus creating the base for a glorious history, diverse culture and tribal simplicity that the state can now call it's very own.</p>
                <hr>
                <details>
                    <summary>Best time to visit</summary>
                    <p class="bttv">It is ideal to visit Jharkhand between October to March as the climatic conditions are most suited for sightseeing during these months. One can pack light to Jharkhand as the weather is pleasant even during winters.</p>
                </details>
                <hr>
                <details>
                    <summary>How to reach</summary>
                    <p class="bttv"><span class="sub_t">By air :</span> Ranchi Airport is the main airport of Jharkhand, which is well connected with Patna, Kolkata, New Delhi and Mumbai by regular Indian Airline, Kingfisher Red and Jetlite services.</p>
                    <p class="bttv"><span class="sub_t">By rail :</span> Ranchi Railway Station and Hazaribagh are the main railheads of Jharkhand. Several express trains connect Ranchi and Hazaribagh with Patna, Kolkata, Rourkela, New Delhi and other significant places of India.</p>
                    <p class="bttv"><span class="sub_t">By road :</span> Ranchi, the capital city is situated at the junction of National Highways 23 and 33. A wide network of roads connects various places of Jharkhand with each other and rest of the country.</p>
                </details>
...
<h2 class="title container" style="margin: 3rem auto; font-family: 'Oleo Script', cursive; font-size:2.5rem; text-align: center;">Places to visit in Jharkhand</h2>
