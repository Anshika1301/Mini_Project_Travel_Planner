...
<?php include('includes/header.php');?>
    <section class="about-us deepshadow" style="position: relative;">
        <h1>RAJASTHAN</h1>
        <img src="Rajasthan/Bikaner/gajner palace.jpg">
...
<div class="container">
    <div class="heading">
        <h2>Places To Visit In Rajasthan</h2>
    </div>
    <div class="row">
        <!-------------------- 1 ------------------------->
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Ajmer/abdulla khans tomb.jpg" alt="sample87" />
                <figcaption>
                    <h2>Ajmer</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/alwar/bala quila fort.jpg" alt="sample87" />
                <figcaption>
                    <h2>Alwar</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Bharatpur/deeg.jpg" alt="sample87" />
                <figcaption>
                    <h2>Bharatpur</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Bikaner/kolayat.jpg" alt="sample87" />
                <figcaption>
                    <h2>kolayat</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Chittorgarh/maha sati.jpg" alt="sample87" />
                <figcaption>
                    <h2>Chittorgarh</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Jaipur/Abhaneri step well.jpg" alt="sample87" />
                <figcaption>
                    <h2>Jaipur</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/jaisalmer/barmer.jpg" alt="sample87" />
                <figcaption>
                    <h2>Jaisalmer</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Jodhpur/Art school.jpg" alt="sample87" />
                <figcaption>
                    <h2>Jodhpur</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Pushkar/apteswar temple.jpg" alt="sample87" />
                <figcaption>
                    <h2>Pushkar</h2>
                    <a href="#"></a>
                </figcaption>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12">
            <figure class="state_img">
                <img src="Rajasthan/Udaipur/bada mahal.jpg" alt="sample87" />
                <figcaption>
                    <h2>Udaipur</h2>
                    <a href="#"></a>
                </figcaption>
